...
ddmmyy_slash = (r'(\s|^|\D)(([012]?\d|3[01])/([012]?\d|3[01])/(20)?1[89])', 2, ["%m/%d/%Y", "%d/%m/%Y", "%m/%d/%y", "%d/%m/%y"])
yyddmm_slash = (r'(\s|^|\D)((20)?1[89]/([012]?\d|3[01])/([012]?\d|3[01]))(\s|$|\D)', 2, ["%Y/%m/%d", "%Y/%d/%m", "%y/%m/%d", "%y/%d/%m"])
ddmmyy_minus = (r'(\s|^|\D)(([012]?\d|3[01])-([012]?\d|3[01])-(20)?1[89])', 2, ["%m-%d-%Y", "%d-%m-%Y", "%m-%d-%y", "%d-%m-%y"])
yyddmm_minus = (r'(\s|^|\D)((20)?1[89]-([012]?\d|3[01])-([012]?\d|3[01]))(\s|$|\D)', 2, ["%Y-%m-%d", "%Y-%d-%m", "%y-%m-%d", "%y-%d-%m"])
ddmmyy_dot = (r'(\s|^|\D)(([012]?\d|3[01])\.([012]?\d|3[01])\.(20)?1[89])(\s|$|\D)', 2, ["%m.%d.%Y", "%d.%m.%Y", "%m.%d.%y", "%d.%m.%y"])
yyddmm_dot = (r'(\s|^|\D)((20)?1[89]\.([012]?\d|3[01])\.([012]?\d|3[01]))(\s|$|\D)', 2, ["%Y.%m.%d", "%Y.%d.%m", "%y.%m.%d", "%y.%d.%m"])
yyddmm_none = (r'(\s|^|\D)((20)?1[89]([012]\d|3[01])([012]\d|3[01]))(\s|$|\D)', 2, ["%Y%m%d", "%Y%d%m", "%y%m%d", "%y%d%m"])
ddmmyy_none = (r'(\s|^|\D)(([012]\d|3[01])([012]\d|3[01])(20)?1[89])(\s|$|\D)', 2, ["%m%d%Y", "%d%m%Y", "%m%d%y", "%d%m%y"])
ddbbyy = (r'(\s|^|\D)(([012]?\d|3[01]) ' + month3 + '[\', ]{0,2}(20)?1[89])', 2, ["%d%b%y", "%d%b%Y"])
bbddyy = (r'(' + month3 + '[\', ]{0,2}([012]\d|3[01])[ ,]{1,2}(20)?1[89])($|[^:])', 1, ["%b%d%y", "%b%d%Y"])
